...
class ExcludeDialog(tk.Toplevel):
    ...
    def __set_edit_frame(self, parent) -> Frame:
        ...
        btn_frame.pack(fill=tk.X, padx=2, pady=(1, 2))
        return btn_frame
    ...
    def __set_preview_path_entry(self, parent: Frame) -> Entry:
        ...
        preview_path_entry.pack(side=tk.LEFT, fill=tk.X, expand=True, padx=(0, 2))
    ...
    def __set_browse_btn(self, parent: Frame) -> Button:
        ...
        browse_btn.pack(side=tk.RIGHT, ipadx=6)
        return browse_btn
