...
注意，新版本还支持了【以文搜图】，但由于它必须使用文字编码模型且模型更大，程序运行时会显著地占用更多内存。它的源代码在分支【main2】中；
你可以选择下载只包含【以图搜图】功能的版本，它体积更小、运行时更轻和更快。它的源代码在分支【main】中；
需要注意，项目暂时只适配Windows系统，因为代码中包含的一些实现利用了Windows的API
...
### 2. Windows系统下的可执行程序
1、以图搜图版本
- (1) [Release下载链接](https://github.com/Just-A-Freshman/VimgFind/releases/download/program/default.zip)
- (2) [蓝奏云下载链接](https://pc.woozooo.com/mydisk.php)
